...
namespace Axis.Dia.IO.Binary.Metadata
{
    public readonly struct CustomMetadata : IDefaultValueProvider<CustomMetadata>
    {
        ...
        public static CustomMetadata Of(byte data) => new CustomMetadata(data);

        public static CustomMetadata Of(sbyte data) => new CustomMetadata((byte)data);

        public static CustomMetadata Of(MetadataFlags flags) => new CustomMetadata((byte)flags);
