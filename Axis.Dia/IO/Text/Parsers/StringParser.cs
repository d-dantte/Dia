    ...
    public class StringParser : IValueSerializer<StringValue>
    {
        ...
        public static IResult<string> Serialize(StringValue value, TextSerializerContext? context = null)
        {
            ...
            var valueText = value.IsNull switch
            {
                ...
                {
                    TextSerializerOptions.TextLineStyle.Singleline => EscapeSequenceGroup
                        .SinglelineStringEscapeGroup
                        .Escape(value.Value)
                        .WrapIn("\"")
                        .ApplyTo(Result.Of),

                    TextSerializerOptions.TextLineStyle.Multiline => StringParser
                    ...
                    _ => Result.Of<string>(new ArgumentException(
                        $"Invalid {nameof(TextSerializerOptions.TextLineStyle)}: {context.Options.Strings.LineStyle}"))
                }
            };
        ...
        internal static string[] FormatAsMultiline(string? value, TextSerializerOptions.StringOptions options)
        {
