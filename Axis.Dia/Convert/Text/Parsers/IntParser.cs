...
namespace Axis.Dia.Convert.Text.Parsers
{
    public class IntParser : IValueSerializer<IntValue>
    {
        ...
        public static IResult<IntValue> Parse(CSTNode symbolNode, TextSerializerContext? context = null)
        {
        ...
        public static IResult<string> Serialize(IntValue value, TextSerializerContext? context = null)
        {
            context ??= new TextSerializerContext();
        ...
        internal static IResult<string> ConvertToText(IntValue value, TextSerializerOptions.IntOptions options)
        {
            var bigInt = value.Value ?? throw new ArgumentException("Invalid int value: 'null'");
            return Result.Of(() => options.NumberFormat switch
            {
                TextSerializerOptions.IntFormat.Decimal => bigInt
                ...
                TextSerializerOptions.IntFormat.BigHex => BigInteger
                    .Abs(bigInt)
                    .ToString("X")
                ...
                TextSerializerOptions.IntFormat.SmallHex => BigInteger
                    .Abs(bigInt)
                    .ToString("x")
                    .ApplyTo(hex => options.UseDigitSeparator
                        ? ApplySeparator(hex, 4)
                ...
                TextSerializerOptions.IntFormat.BigBinary => BigInteger
                    .Abs(bigInt)
                ...
                TextSerializerOptions.IntFormat.SmallBinary => BigInteger
                    .Abs(bigInt)
                    .ApplyTo(BitSequence.Of)
                    .ApplyTo(ToBinaryString)
                    .ApplyTo(bin => options.UseDigitSeparator
