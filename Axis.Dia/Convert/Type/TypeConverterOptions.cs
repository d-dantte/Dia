...
{
    //public readonly struct TypeConverterOptions: IDefaultValueProvider<TypeConverterOptions>
    //{
    //    /// <summary>
    ...
    //    /// <summary>
    //    /// A readonly map of poco types to property names, indicating properties that should be ignored by the converter
    ...
    //    public bool IsDefault => default(TypeConverterOptions).Equals(this);

    //    public static TypeConverterOptions Default => default;
    //    #endregion
