...
namespace Axis.Dia.Convert.Type.Clr
{
    ...
    {
        private readonly Dictionary<Guid, TrackingInfo> map = new();

        internal bool IsTracked(IDiaReference linkedReference, out TrackingInfo? info)
        {
        ...
        /// <item>The tracking info is an instance of <see cref="TrackingInfo.Placeholder"/></item>
        /// </list>
        /// </summary>
            ...
            Action<object?> initializer)
        {
            if (value is IDiaReference linkedRef
                ...
                && info is TrackingInfo.Placeholder placeholder)
            {
        ...
        /// <summary>
        /// Tracks the given <paramref name="linkedReference"/> instance as a <see cref="TrackingInfo.Placeholder"/>, then call the 
        /// <paramref name="converter"/> delegate to produce the value, which is in turn returned, after replacing the <see cref="TrackingInfo.Placeholder"/>
        ...
        /// <see cref="TrackingInfo.Placeholder"/>, with whom thay may choose to register call-backs to utilize the subsequently produced value.
        /// </summary>
            ...
            Func<IResult<object?>> converter)
        {
            ...
            map[linkedReference.ValueAddress] = new TrackingInfo.Placeholder();
        ...
        private object? ApplyPlaceholderValue(IDiaReference linkedReference, object? value)
        {
            ...
            if (trackingInfo is TrackingInfo.Placeholder placeholder)
            {
                placeholder.ApplyValue(value);
                map[linkedReference.ValueAddress] = new TrackingInfo.Value(value);
                return value;
            }
    ...
    internal abstract class TrackingInfo
    {
        internal class Value : TrackingInfo
        {
        ...
        internal class Placeholder: TrackingInfo
        {
