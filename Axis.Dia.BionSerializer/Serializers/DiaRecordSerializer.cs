...
namespace Axis.Dia.BionSerializer.Serializers
{
        ...
        IDefaultInstance<DiaRecordSerializer>
    {
        ...
        public void SerializeType(Core.Types.Record value, SerializerContext context)
        {
        ...
        public void SerializeProperty(Record.Property property, SerializerContext context)
        {
            ArgumentNullException.ThrowIfNull(context);
