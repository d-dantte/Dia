...
namespace Axis.Dia.Tests.IO.Binary.Serializers
{
    ...
    public class IntPayloadSerializerTests
    {
        ...
        {
            var nullValue = IntValue.Null();
            var result = IntPayloadSerializer.Serialize(nullValue, new Dia.IO.Binary.BinarySerializerContext());
            ...
            result = IntPayloadSerializer.Serialize(zeroValue, new Dia.IO.Binary.BinarySerializerContext());
            Assert.IsTrue(result.IsDataResult());
            data = result.Resolve();
            Assert.AreEqual(1, data.Length);
            ...
            IntValue oneValue = 1;
            result = IntPayloadSerializer.Serialize(oneValue, new Dia.IO.Binary.BinarySerializerContext());
            Assert.IsTrue(result.IsDataResult());
            data = result.Resolve();
            ...
            result = IntPayloadSerializer.Serialize(otherInt, new Dia.IO.Binary.BinarySerializerContext());
            Assert.IsTrue(result.IsDataResult());
            data = result.Resolve();
