...
{
    [TestClass]
    public class SymbolEscapeSequenceGroupTests
    {
        [TestMethod]
        public void Escape_WithNoEscapeSequence_ReturnsInputString()
        {
            var sesg = new SymbolEscapeSequenceGroup();
        ...
        [TestMethod]
        public void Escape_WithSingleQuote_ShouldEscapeTheQuotes()
        {
            var sesg = new SymbolEscapeSequenceGroup();
            var input = "The quick brown fox jumps over the lazy dog";
            var result = sesg.Escape($"'{input}'");
        ...
        [TestMethod]
        public void Unescape_WithSingleQuote_ShouldUnecapeTheQuotes()
        {
            var sesg = new SymbolEscapeSequenceGroup();
            var input = "The quick brown fox \\\'jumps\\\' over the lazy dog";
        ...
        [TestMethod]
        public void UnescapeGreedyLines_ShouldIgnoreTheWhitespaces()
        {
            var sesg = new SymbolEscapeSequenceGroup();
            ...
            Assert.AreEqual(@"The quick brown fox jumps \
                          over the lazy dog", result);
        }
