...
namespace Axis.Dia.Tests.Convert.Text.Parsers
{
    ...
    public class SymbolParserTests
    {
        ...
        public  void SerializeTest()
        {
            ...
            var result = SymbolParser.Serialize(value, new TextSerializerContext(options));
            ...
            result = SymbolParser.Serialize(value, new TextSerializerContext(options));
            Assert.IsTrue(result.IsDataResult());
            text = result.Resolve();
            Console.WriteLine(text);
        ...
        public void ParseTest()
        {
            ...
            var textResult = SymbolParser.Serialize(value, new TextSerializerContext(options));
            ...
            textResult = SymbolParser.Serialize(value, new TextSerializerContext(options));
