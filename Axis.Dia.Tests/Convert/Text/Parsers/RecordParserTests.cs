...
namespace Axis.Dia.Tests.Convert.Text.Parsers
{
    ...
    public class RecordParserTests
    {
        ...
        public void SerializeTests()
        {
            ...
            var result = RecordParser.Serialize(value, new TextSerializerContext(options));
            ...
            result = RecordParser.Serialize(value, new TextSerializerContext(options));
            Assert.IsTrue(result.IsDataResult());
            text = result.Resolve();
            Console.WriteLine(text);
        ...
        public void ParseTests()
        {
            ...
            var textResult = RecordParser.Serialize(value, new TextSerializerContext(options));
            ...
            textResult = RecordParser.Serialize(value, new TextSerializerContext(options));
