...
namespace Axis.Dia.Tests.Convert.Text.Parsers
{
    ...
    public class BlobParserTests
    {
        ...
        public void SerializeTest()
        {
            ...
            var result = BlobParser.Serialize(value, new TextSerializerContext(options));
            ...
            result = BlobParser.Serialize(value, new TextSerializerContext(options));
            Assert.IsTrue(result.IsDataResult());
            text = result.Resolve();
            Console.WriteLine(text);
        ...
        public void ParseTest()
        {
            ...
            var textResult = BlobParser.Serialize(value, new TextSerializerContext(options));
            ...
            value = BlobValue.Of(Bytes);
            textResult = BlobParser.Serialize(value, new TextSerializerContext(options));
        ...
        public void WrapLinesTest()
        {
            ...
            var lines = BlobParser.WrapLines(slines, new TextSerializerContext(options));
            Assert.AreEqual("<\r\n    first line\r\n    second line\r\n    third line\r\n>", lines);


            lines = BlobParser.WrapLines(slines, new TextSerializerContext(options).IndentContext());
